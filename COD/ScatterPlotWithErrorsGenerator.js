function generateScatterPlotWithErrors(containerWidth, containerHeight, margin, data, id) {
    ...
    const scatterGroup = svg.selectAll(".scatter-group")
        .data(sortedData)
        .enter()
        .append("g")
